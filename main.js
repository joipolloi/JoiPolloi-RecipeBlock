...
/*!***********************!*\
  !*** ./js/helpers.js ***!
  \***********************/
/*! exports provided: debounce, getAbsoluteHeight */
...
/* harmony import */ var _recipe_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./recipe.js */ "./js/recipe.js");


const recipeHTML = document.querySelector('.recipe');
const recipeInstance = new _recipe_js__WEBPACK_IMPORTED_MODULE_1__["default"](recipeHTML);
window.addEventListener('resize', Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["debounce"])(recipeInstance.resize()));
...
class Recipe {
  ...
  init() {
    const scroller = new simplebar__WEBPACK_IMPORTED_MODULE_0__["default"](this.ingredientsContainer, {
      autoHide: false
    });
  ...
  setSidebarHeight() {
    const methodHeight = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getAbsoluteHeight"])(this.method);
    const ingredientsHeight = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getAbsoluteHeight"])(this.ingredientsContainer);

    if (ingredientsHeight < methodHeight && window.innerWidth >= 1024) {
      // Method longer than ingredients, desktop/wide size
      this.sidebar.style.height = methodHeight + 'px';
    } else if (ingredientsHeight >= methodHeight && window.innerWidth >= 1024) {
      // Ingredients longer than method, desktop/wide size
    ...
    if (window.innerWidth < 1024) {
      ...
      const headerHeight = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getAbsoluteHeight"])(document.querySelector('.site-header'));
...
var api = __webpack_require__(/*! ../../style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
            var content = __webpack_require__(/*! !../../css-loader/dist/cjs.js!./simplebar.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/simplebar/dist/simplebar.css");
